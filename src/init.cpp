...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9331 or testnet: 19331)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9330 or testnet: 19330)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Quickcoin Wiki for SSL setup instructions)") + "\n" +
